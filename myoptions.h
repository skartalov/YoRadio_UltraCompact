...
/*        I2S DAC                 */
#define I2S_DOUT          25                /*  DIN connection. Should be set to 255 if the board is not used */
...
/*  BUTTONS  */
#define BTN_LEFT              21           /*  VolDown, Prev */
#define BTN_CENTER            32           /*  Play, Stop, Show playlist */
#define BTN_RIGHT             17           /*  VolUp, Next */
//#define BTN_UP                22           /*  Prev, Move Up */
//#define BTN_DOWN              33           /*  Next, Move Down */
...
//#define BTN_MODE            32           /*  MODE switcher  */
/******************************************/
...
#define BRIGHTNESS_PIN    14               /*  Pin for adjusting the brightness of the display (output 0 - 3v3) */
